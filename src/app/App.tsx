        ...
        <div className="max-w-[1800px] mx-auto p-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-3 space-y-4">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                ...
                <div className="mb-5">
                  <div className="flex items-center gap-2 mb-4">
                    <div className={`w-7 h-7 rounded-full flex items-center justify-center text-sm font-bold ${currentStep >= 1 ? 'bg-amber-500 text-white' : 'bg-gray-200 text-gray-500'
                      }`}>
                      1
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      ...
                      className={`relative px-4 py-3 text-sm font-semibold border-2 rounded-xl transition-all duration-200 ${aspectRatio === '3:4'
                    ...
                    <button
                      ...
                      className={`relative px-4 py-3 text-sm font-semibold border-2 rounded-xl transition-all duration-200 ${aspectRatio === '9:16'
                        ? 'bg-amber-500 text-white border-amber-500 shadow-lg shadow-amber-200'
                        : 'bg-white text-gray-700 border-gray-200 hover:border-amber-300 hover:bg-amber-50'
                        }`}
                    >
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                <div className="flex items-center gap-2 mb-4">
                  <div className={`w-7 h-7 rounded-full flex items-center justify-center text-sm font-bold ${currentStep >= 2 ? 'bg-amber-500 text-white' : 'bg-gray-200 text-gray-500'
                    }`}>
                    3
                  </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                <div className="flex items-center gap-2 mb-4">
                  <div className={`w-7 h-7 rounded-full flex items-center justify-center text-sm font-bold ${currentStep >= 3 ? 'bg-amber-500 text-white' : 'bg-gray-200 text-gray-500'
                    }`}>
                    4
                  </div>
