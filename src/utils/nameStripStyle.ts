 ...
 *
 * Strip background = pure black mixed with `dominantColor` at 45% opacity.
 * Result RGB = dominantColor * 0.45 (since black contributes 0).
 *
...
/** black + 45% dominant => result RGB = dominant * 0.45. */
export function nameStripBackgroundHex(dominantColorHex: string | null | undefined): string {
  ...
  return toHex(rgb.r * 0.45, rgb.g * 0.45, rgb.b * 0.45);
}
